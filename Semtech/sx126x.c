 ...
 */
//#include "D:/TELECOS/4A/PAE/COMMS/sx126x_cadexampleWeb/src/radio/sx126x/sx126x.h"
...
void SX126xSetSleep( SleepParams_t sleepConfig )
{
    ...
    SX126xWriteCommand( RADIO_SET_SLEEP, ( uint8_t* ) &sleepConfig.Value, 1 );	//CHECK THIS CAST!!!!!! (IT WAS NOT HERE BEFORE)
