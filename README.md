...
# Desired Structure
    ...
    │       ├── /Core
    │       └── /Device
    ├── /Middlewares        # Optional middleware libraries (e.g., FreeRTOS)
    ├── /CommonResources     # Common resources or utilities
    ...
    │   ├── test_main.c
    │   └── test_utils.c
    ├── /Build              # Build output (can be ignored in version control)
    ├── /Scripts            # Scripts for automation (e.g., build scripts)
    ├── CMakeLists.txt      # CMake configuration file
    ├── toolchain-stm32l4.cmake  # Toolchain file for cross-compilation
    └── STM32L476xx.ld      # Linker script
